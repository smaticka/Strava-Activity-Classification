...
# run the script to remove covariates and output plots
...
############### Linear Regression models (required for project)
# Predicting start time of activity, based on parameters
...
# cat for categorical prediction. 
